...
def editworkout(workout_id, username):
    ...
    workout = list(mongo.db.Workouts.find({"user": session["user"]}))
    return render_template('update-workout.html', username=username, edit=edit,
                           workouts=workout, files=file)
...
def editgoal(goal_id, username):
    ...
    goal = list(mongo.db.Goals.find({"user": session["user"]}))
    return render_template('update-profile.html', username=username, edit=edit,
...
def editgoalcompleted(goal_id, username):
    ...
    goal = list(mongo.db.Goals.find({"user": session["user"],
                                     "Completed": "Complete"}))
    return render_template('update-profile-completed.html', username=username,
...
def editgoalinprogress(goal_id, username):
    ...
    goal = list(mongo.db.Goals.find({"user": session["user"],
                                     "Completed": "Incomplete"}))
    return render_template('update-profile-inprogress.html', username=username,
                           edit=edit, goals=goal, files=file)
